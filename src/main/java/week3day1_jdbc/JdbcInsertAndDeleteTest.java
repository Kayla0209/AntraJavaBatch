...
public class JdbcInsertAndDeleteTest {
    public static void main(String[] args) {
        try(
            ...
            String sqlDelete = "delete from books where title = 'Json'";
            ...
            String sqlInsert = "insert into books values ('Math', 100, 4)";
            ...
            String sqlMultiInsert = "insert into books values ('English', 123, 4), "
                    + "('Net', 321, 5)";
            ...
            String sqlPartialInsert = "insert into books (title, price) values ('Data', 458)";
